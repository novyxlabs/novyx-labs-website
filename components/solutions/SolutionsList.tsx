...
const solutions = [
  {
    ...
    status: 'live',
    price: 'Contact Us',
    description: 'A persistent AI brain for enduring knowledge graphs. The flagship product powering all Novyx Labs capabilities.',
    icon: <Brain className="w-7 h-7 text-white" />,
    features: [
      'Persistent memory—never forgets',
      'Multi-tenant architecture',
      'Built-in versioning and rollback',
      'Federation-ready for distributed systems',
      'Enterprise-grade security',
      'Sub-second query responses',
    ],
    link: '/core',
    badgeColor: 'bg-green-500',
    badgeText: 'Live Flagship',
  },
  {
    name: 'Federation Sync',
    status: 'live',
    price: 'Core Extension',
